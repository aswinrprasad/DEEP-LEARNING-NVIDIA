...
# 
# Additionally, if you're an advanced user and would prefer to use a terminal for this lab you can click [terminal]((../../../../terminals/1)) and run all the lab exercises this way.
...
get_ipython().system(u'python exercises/simple/runTraining.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train')
...
get_ipython().system(u'python exercises/simple/runEval.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train         --eval_dir /dli/tasks/tensorboard/eval')
...
get_ipython().system(u'python exercises/cnn/runTraining.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train         --num_epochs 30')
...
get_ipython().system(u'python exercises/cnn/runEval.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train         --eval_dir /dli/tasks/tensorboard/eval')
...
get_ipython().system(u'python exercises/cnnDice/runTraining.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train          --num_epochs 10')


# In[14]:


get_ipython().system(u'python exercises/cnnDice/runEval.py --data_dir /dli/data/img_segmentation --checkpoint_dir /dli/tasks/tensorboard/train         --eval_dir /dli/tasks/tensorboard/eval')
...
get_ipython().system(u'python exercises/cnnDice/runTraining.py --data_dir /dli/data/img_segmentation  --checkpoint_dir /dli/tasks/tensorboard/train         --num_epochs 15 --learning_rate 0.1 --decay_rate 0.1 --decay_steps 3800')
...
get_ipython().system(u'tar -czf ImageSegmentation.tar.gz exercise_solutions/ exercises/ images/*png')
